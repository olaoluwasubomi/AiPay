 ...
 * - Save as: src/Pages/buyer/ProductDetails.jsx
 * - Use <ProductDetailsPage /> for a routable demo, or import { ProductDetailsModal } as a reusable dialog.
 */

// Demo product (replace via props or store)
const DEMO_PRODUCT = {
  id: 1,
  name: "Chicken Burger",
  ...
  compareAt: 2500,
  description:
    "Chicken Burger — a delicious fusion of premium, tender chicken patty seasoned to perfection, nestled between soft, golden buns. Satisfy your cravings for a hearty meal with this mouthwatering creation that combines quality ingredients with a burst of flavors.\n\nWhether you're a chicken lover or simply seeking a delightful twist on the classic burger, our Chicken Burger promises a delectable experience that will leave you coming back for more. Elevate your dining moments with this culinary delight, available for convenient delivery right to your doorstep.",
};
...
export default function ProductDetailsPage() {
  ...
  const total = useMemo(() => qty * product.price, [qty, product.price]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E8F2FF] to-white">
      <ProductDetailsModal
        ...
        onAddToCart={() => alert(`Added ${qty} item(s) — NGN ${formatNGN(total)}`)}
      />
    </div>
  );
}
          ...
          <div className="p-6">
            ...
            <div className="mt-5">
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                {product.compareAt && (
                  <p className="text-xs text-slate-400 line-through">NGN {formatNGN(product.compareAt)}</p>
                )}
              </div>
            </div>
